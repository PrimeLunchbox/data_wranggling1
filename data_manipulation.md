...
this function does the same thing as the one above (relocating the
“litter_number”column to the first)
...
arrange two columns simultaneously (with order: column
“pups_born_alive”first and then “gd0_weight”)
